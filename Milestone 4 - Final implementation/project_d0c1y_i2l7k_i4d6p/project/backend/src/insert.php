<html>
    ...
    <body>
        ...
        <h2>Insert Values into Team</h2>
        <form method="POST" action="insert.php"> <!--refresh page when submitted-->
            <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
            team_id: <input type="text" name="insTeamID"> <br /><br />
            team_name: <input type="text" name="insTeamName"> <br /><br />
        ...
        function connectToDB() {
            ...
            $db_conn = OCILogon("ora_slater20", "a46173688", "dbhost.students.cs.ubc.ca:1522/stu");
