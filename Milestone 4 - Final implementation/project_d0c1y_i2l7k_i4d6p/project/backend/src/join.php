<html>
    ...
    <body>
        ...
        <h2>View Players by Position (Join)</h2>
        ...
        function handleInsertRequest() {
            ...
            $result = executeBoundSQL("select person_works_for_2.nam from person_works_for_2 , player_2 where person_works_for_2.person_id = player_2.person_id and player_2.position = :bind1", $alltuples);
            echo "<table>";
